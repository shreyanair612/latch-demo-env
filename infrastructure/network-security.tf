...
# Justification: The source address prefix for the SSH rule was changed from a restricted IP range (10.0.0.0/8) to allow all IPs (*), which significantly compromises network security by enabling unrestricted access to

...
# Justification: The source address prefix for the HTTPS security rule was changed from a restricted IP range (10.0.0.0/8) to an open wildcard (*) allowing access from any IP address, which compromises network securit

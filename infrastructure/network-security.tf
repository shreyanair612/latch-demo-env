...
# Justification: The source address prefix for the HTTPS security rule was changed from a restricted range (10.0.0.0/8) to an open wildcard (*) allowing unrestricted access, which compromises the confidentiality and i

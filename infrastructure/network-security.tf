...
# Justification: The security rule 'AllowAll8080' was modified to allow TCP protocol traffic, which could expose the system to unauthorized access and compromise the confidentiality and integrity of electronic records

...
# Justification: The change allows TCP traffic on port 8080, which was previously restricted. This could expose the system to unauthorized access or data interception, compromising confidentiality and integrity.

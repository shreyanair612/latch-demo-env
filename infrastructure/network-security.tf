...
# Justification: The destination address prefix for the security rule 'AllowAll8080' was changed to '*', which allows unrestricted access to all destinations. This compromises the confidentiality and integrity of the 

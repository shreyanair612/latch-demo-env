...
# Justification: The sourceAddressPrefix for the AllowSSH rule was changed from a restricted IP range (10.0.0.0/8) to an open wildcard (*) allowing SSH access from any IP address, which compromises the confidentiality

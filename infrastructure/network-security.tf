...
# Justification: The sourceAddressPrefix for the AllowHTTPS rule was changed from a restricted IP range (10.0.0.0/8) to an open wildcard (*) allowing traffic from any source, which compromises network security and vio

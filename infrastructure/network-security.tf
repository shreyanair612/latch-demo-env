...
# Justification: The source address prefix for the HTTPS security rule was changed from a restricted IP range (10.0.0.0/8) to an open wildcard (*) allowing traffic from any source. This compromises network security an

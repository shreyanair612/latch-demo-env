...
# Justification: The change allows inbound traffic on port 8080, which was previously not permitted. This compromises the confidentiality and integrity of the system by potentially exposing it to unauthorized access.

...
# Justification: The source address prefix for the AllowHTTPS rule was changed from a restricted range (10.0.0.0/8) to an open wildcard (*), which allows traffic from any source. This significantly weakens network sec

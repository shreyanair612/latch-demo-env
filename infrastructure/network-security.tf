...
# Justification: The source address prefix for the SSH rule was changed from a restricted range (10.0.0.0/8) to allow all (*) traffic, which compromises network security by permitting unauthorized access.

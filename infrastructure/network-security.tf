...
# Justification: The change allows TCP traffic on port 8080, which was previously not permitted. This could expose the system to unauthorized access or data breaches, compromising the confidentiality and integrity of 

...
# Justification: The scope of the role assignment for pipeline-deployer has been expanded from a resource group level to the subscription level, granting broader access than originally validated. This change increases

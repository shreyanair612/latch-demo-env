...
# Justification: The condition restricting 'Microsoft.Authorization/roleAssignments/write' actions has been removed, allowing unrestricted role assignment changes. This compromises access control and could enable unau

...
# Justification: The scope of the role assignment for pipeline-deployer has been expanded from a resource group level to the entire subscription, potentially granting excessive permissions beyond the validated boundar

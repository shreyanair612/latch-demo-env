...
# Justification: The scope of the role assignment for pipeline-deployer has been expanded from a resource group level to the subscription level, which significantly increases access permissions and could allow unautho

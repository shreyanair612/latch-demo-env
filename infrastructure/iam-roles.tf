...
# Justification: The condition attribute for the pipeline IAM role was removed, eliminating the restriction that prevented unauthorized write actions to role assignments. This compromises access control and increases 

...
# Justification: The scope of the role assignment for the pipeline-deployer was changed from a resource group level to the subscription level, significantly broadening access permissions. This violates the principle o

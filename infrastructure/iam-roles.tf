...
# Justification: The removal of the condition attribute from the role assignment allows unrestricted write access to role assignments, which compromises access control and violates the principle of least privilege.

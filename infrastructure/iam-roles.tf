...
# Justification: The role assignment for 'pipeline-deployer' was changed from 'Contributor' to 'Owner', granting excessive permissions that could allow unauthorized access or modifications to validated systems and dat

...
# Justification: The removal of 'properties.conditionVersion' from the role assignment invalidates conditional access policies, which are essential for ensuring system access is limited to authorized individuals under

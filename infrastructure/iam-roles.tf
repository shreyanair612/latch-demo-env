...
# Justification: The removal of the condition attribute from the role assignment allows unrestricted write access to role assignments, bypassing the validated control that restricted this action. This compromises acce

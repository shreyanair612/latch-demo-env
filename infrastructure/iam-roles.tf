...
# Justification: The conditionVersion attribute for the pipeline IAM role was removed, which disables conditional access policies. This compromises access control mechanisms and could allow unauthorized access to the 

...
# Justification: The scope of the IAM role assignment has been expanded from a resource group level to the entire subscription, which increases the risk of unauthorized access to sensitive GxP data and systems.

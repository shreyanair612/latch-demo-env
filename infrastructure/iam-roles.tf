...
# Justification: The condition attribute for the pipeline IAM role was removed, which previously restricted write actions on role assignments. This change allows unrestricted write access to role assignments, potentia

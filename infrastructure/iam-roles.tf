...
# Justification: The scope of the role assignment for pipeline-deployer has been expanded from a resource group level to the entire subscription. This change increases the risk of unauthorized access to sensitive GxP 

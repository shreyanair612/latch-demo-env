...
# Justification: The scope of the role assignment for pipeline-deployer has been expanded from a resource group level to the subscription level, potentially granting broader access than intended. This change compromis

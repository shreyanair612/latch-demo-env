...
# Justification: The 'supportsHttpsTrafficOnly' attribute was changed from True to False, allowing unencrypted traffic to the storage account, which compromises data confidentiality and integrity.

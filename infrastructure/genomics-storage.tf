...
# Justification: The 'supportsHttpsTrafficOnly' attribute was changed from True to False, allowing unencrypted HTTP traffic, which compromises the confidentiality and integrity of electronic records stored in the FDA-

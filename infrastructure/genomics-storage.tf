...
# Justification: The minimum TLS version for the storage account was downgraded from TLS 1.2 to TLS 1.0, which is an outdated and insecure protocol. This compromises the confidentiality and integrity of data in transi
